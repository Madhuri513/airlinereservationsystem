				...
				case 1:
					...
					for (FlightDetails details : records) {
						log.info(String.format("%-10s %-15s %-10s %-17s %-15s %-13s %-10s %-15s %-15s %s", details.getFlightId(),
								...
								details.getDepartureTime(), details.getDepartureDate(), details.getSource(),details.getDestination(), details.getNoOfSeats(),
								details.getPrice()));
					}
				...
				case 7:
					...
					for (TicketsInfo details : bookings) {
						log.info(String.format("%-10s %-15s %-15s %s", details.getTicketId(),
								details.getUserDetails().getUserId(), details.getFlightDetails().getFlightId(),	details.getNoOfSeatsBooked()));
					}
					break;
